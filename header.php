    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-sm-4 col-xs-12">
                <p><i class="fa fa-phone"></i><span> Phone</span>+91 93601481163</p>
            </div>
            <div class="col-md-3 col-sm-4 col-xs-12">
                <p><i class="fa fa-envelope-o"></i><span> Email</span><a href="#">contact@eventplanner.com</a></p>
            </div>
...
<li class="profile-container">
    ...
    <ul class="dropdown-menu">
        <li><a href="customeraccount.php">My Profile</a></li><br/>
        <li><a href="customerprofile.php">Edit Customer profile</a></li><br/>
